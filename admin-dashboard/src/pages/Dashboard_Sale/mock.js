...
export default {
  ...
  apexPie: {
    options: {
      ...
      colors: [config.light.success, config.light.secondary, config.light.warning],
      labels: ["Amazon", "Inhaber", "Ebay"],
      legend: {

      }
    },
    series_order: [400, 300, 200],
  },
  ...
  apexArea3: {
    ...
    series: [
      {
        data: [155, 256, 152, 101, 112, 155, 123]
      }
    ],
  },
  ...
  mainApexArea: {
    options: {
      ...
      colors: [config.light.warning, config.light.success, config.light.secondary],
      yaxis: {
        axisBorder: {
          show: true,
          color: '#B9B9B980'
